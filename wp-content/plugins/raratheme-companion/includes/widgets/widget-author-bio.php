...
class RaraTheme_Author_Bio extends WP_Widget {
    ...
    */
    ...
    public function form( $instance ) {
        ...
        <div class="widget-side-note" class="example-text"><?php $link1 = '<a href="http://en.gravatar.com/" target="_blank">Gravatar</a>'; echo sprintf( __( 'You can show your %1$s image instead of manually uploading your photo. Just add your gravatar registered email address here.','raratheme-companion'), $link1 );?></div>
