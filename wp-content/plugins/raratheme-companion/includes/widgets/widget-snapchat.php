...
class raratheme_snapcode_widget extends WP_Widget {
	...
	function form($instance) {
		...
		<p><?php _e('Step 1. Download your Snapcode PNG image from','raratheme-companion');?> <a href="https://accounts.snapchat.com/accounts/snapcodes?type=png" target="_blank"><?php _e('this link','raratheme-companion');?></a>.</p>
